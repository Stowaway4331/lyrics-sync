/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d8ad0085e697e0f76e5e7fd033f092a6)
...
interface __BaseEnv_Env {
	...
	PIPELINE: Workflow<Parameters<import("./src/index").LyricsPipeline['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ACR_HOST" | "ACR_ACCESS_KEY" | "ACR_ACCESS_SECRET">> {}
}
