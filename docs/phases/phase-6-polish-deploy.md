...
- [ ] 6.1 History screen with two-step clear, empty and error states
- [ ] 6.2 README: setup, secrets, architecture, how each assignment criterion is met
- [ ] 6.3 Final checks: lint, typecheck, tests, expo-doctor
